						...
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
									<div class="card-inner">
										<p class="card-heading">请使用充值码充值</p>
										<p><a href="http://www.bdwpay.com/cay/F429D07C968E77E2">点击购买充值码</a></p>
										<p>购买充值码后请等待网页跳转，复制充值码到下面并点击充值</p>
									...
									<div >
										<div class="card-action-btn pull-left">
											<button class="btn btn-flat waves-attach" id="code-update" ><span class="icon">check</span>&nbsp;点击充值</button>
										</div>
									</div>
								</div>
							</div>
