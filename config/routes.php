...
$app->group('/user', function () {
    //教程
    $this->get('/win', 'App\Controllers\UserController:win');
    $this->get('/mac', 'App\Controllers\UserController:mac');
    $this->get('/ios', 'App\Controllers\UserController:ios');
    $this->get('/android', 'App\Controllers\UserController:android');
    $this->get('/sstap', 'App\Controllers\UserController:sstap');
    ...
    //test
    $this->get('/test', 'App\Controllers\UserController:maint');
    //$this->get('/test', 'App\Controllers\UserController:shop');
    //$this->get('/shop', 'App\Controllers\UserController:maint');    
